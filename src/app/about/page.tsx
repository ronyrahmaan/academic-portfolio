      ...
      <div className="bg-white px-6 py-32 lg:px-8">
        <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
          ...
          <div className="mt-10 max-w-2xl">
            ...
            <div className="mt-16">
              <h2 className="text-2xl font-bold tracking-tight text-gray-900">Research Interests</h2>
            ...
            <div className="mt-16">
              ...
              <div className="mt-8 space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">PhD in [Field]</h3>
                  <p className="text-gray-600">University Name, Year</p>
                  <p className="mt-2 text-sm text-gray-600">Dissertation: "Title of your dissertation"</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Master's Degree</h3>
                  <p className="text-gray-600">University Name, Year</p>
                </div>
                <div>
            ...
            <div className="mt-16">
              <h2 className="text-2xl font-bold tracking-tight text-gray-900">Current Position</h2>
              <div className="mt-8">
                <p>
          ...
          <div className="mt-16 max-w-2xl">
            <h2 className="text-2xl font-bold tracking-tight text-gray-900">Awards and Recognition</h2>
            <div className="mt-8">
