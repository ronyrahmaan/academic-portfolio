        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <div className="flex flex-col space-y-2">
                ...
                <select
                  ...
                  className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-space-grotesk focus:ring-2 focus:ring-stone-500 focus:border-transparent"
                >
          ...
          <div className="space-y-8">
            {filteredPublications.map((publication) => (
              <article key={publication.id} className="bg-gradient-to-br from-white to-stone-50 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-8 border border-stone-100">
                  ...
                  <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200">
                    {publication.doi && (
                      <a
                        ...
                        className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg text-sm font-cinzel font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300"
                      >
                    ...
                    {publication.url && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-600 to-green-500 text-white rounded-lg text-sm font-cinzel font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300"
                      >
                        <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
