          ...
          <div className="mt-10 max-w-2xl">
            ...
            <div className="mt-16">
              ...
              <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600 font-space-grotesk">
                ...
                <li className="flex gap-x-3">
                  <span className="mt-1 h-5 w-5 flex-none text-green-600">👥</span>
                ...
                <li className="flex gap-x-3">
                  <span className="mt-1 h-5 w-5 flex-none text-purple-600">🏛️</span>
                ...
                <li className="flex gap-x-3">
                  <span className="mt-1 h-5 w-5 flex-none text-orange-600">🚀</span>
                ...
                <li className="flex gap-x-3">
                  <span className="mt-1 h-5 w-5 flex-none text-red-600">🎯</span>
